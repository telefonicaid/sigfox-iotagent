...
LABEL "org.opencontainers.image.documentation"="https://iotagent-sigfox.readthedocs.io/"
LABEL "org.opencontainers.image.vendor"="Telefónica Investigación y Desarrollo, S.A.U"
LABEL "org.opencontainers.image.licenses"="AGPL-3.0-only"
LABEL "org.opencontainers.image.title"="FIWARE IoT Agent for Sigfox with PM2"
LABEL "org.opencontainers.image.description"="An Internet of Things Agent for the Sigfox callbacks protocol and the NGSI interface of a context broker."
LABEL "org.opencontainers.image.source"="https://github.com/${GITHUB_ACCOUNT}/${GITHUB_REPOSITORY}"
LABEL "org.nodejs.version"="${NODE_VERSION}"

COPY --from=builder /opt/iotasigfox /opt/iotasigfox
RUN npm install pm2@4.4.0 -g --no-package-lock --no-optional

USER node
ENV NODE_ENV=production
# Expose 4041 for NORTH PORT, 17428 for SIGFOX PORT
EXPOSE ${IOTA_NORTH_PORT:-4041} ${IOTA_SIGFOX_PORT:-17428}
CMD ["pm2-runtime", "/opt/iotasigfox/bin/iotagent-sigfox", "-- ", "config.js"]
...
LABEL "org.opencontainers.image.vendor"="Telefónica Investigación y Desarrollo, S.A.U"
LABEL "org.opencontainers.image.licenses"="AGPL-3.0-only"
LABEL "org.opencontainers.image.title"="FIWARE IoT Agent for Sigfox (Distroless)"
LABEL "org.opencontainers.image.description"="An Internet of Things Agent for the Sigfox callbacks protocol and the NGSI interface of a context broker."
LABEL "org.opencontainers.image.source"="https://github.com/${GITHUB_ACCOUNT}/${GITHUB_REPOSITORY}"
LABEL "org.nodejs.version"="${NODE_VERSION}"
...
# Expose 4041 for NORTH PORT, 17428 for SIGFOX PORT
EXPOSE ${IOTA_NORTH_PORT:-4041} ${IOTA_SIGFOX_PORT:-17428}
CMD ["./bin/iotagent-sigfox", "-- ", "config.js"]
...
LABEL "org.opencontainers.image.vendor"="Telefónica Investigación y Desarrollo, S.A.U"
LABEL "org.opencontainers.image.licenses"="AGPL-3.0-only"
LABEL "org.opencontainers.image.title"="FIWARE IoT Agent for Sigfox"
LABEL "org.opencontainers.image.description"="An Internet of Things Agent for the Sigfox callbacks protocol and the NGSI interface of a context broker."
LABEL "org.opencontainers.image.source"="https://github.com/${GITHUB_ACCOUNT}/${GITHUB_REPOSITORY}"
LABEL "org.nodejs.version"="${NODE_VERSION}"
...
# Expose 4041 for NORTH PORT, 17428 for SIGFOX PORT
EXPOSE ${IOTA_NORTH_PORT:-4041} ${IOTA_SIGFOX_PORT:-17428}
CMD ["node", "/opt/iotasigfox/bin/iotagent-sigfox", "-- ", "config.js"]
HEALTHCHECK --interval=30s --timeout=3s --start-period=10s \
